...
public class OncologyScreeningMetadata extends AbstractMetadataBundle {
	...
	{
		this.install(CoreConstructors.program("Oncology Program", "Oncology program",
		    "116030AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "64d6b82c-08a9-11eb-b236-077a7c74158b"));
		this.install(CoreConstructors.encounterType("Oncology Initial", "Initial oncology encounter type",
		    "586660a8-08ca-11eb-9dac-6f55ef0a3a7d"));
		this.install(CoreConstructors.encounterType("Oncology Discontinue", "Discontinue oncology encounter type",
		    "7ae70e0c-08ca-11eb-9325-676401a68809"));
		this.install(CoreConstructors.encounterType("Oncology Followup", "Follow up oncology encounter type",
		    "984405fe-08ca-11eb-bb7a-cb6ccfe9c91e"));
		this.install(CoreConstructors.encounterType("Oncology Screening", "Oncology screening  encounter type",
		    "e24209cc-0a1d-11eb-8f2a-bb245320c623"));
		this.install(CoreConstructors.encounterType("Family cancer history", "Family cancer history encounter type",
		    "b9c51a7e-0e24-11eb-9559-13c33ac53eec"));
		this.install(CoreConstructors.form("Oncology Initial enrollment form", "Initial form for oncology enrollment",
		    "586660a8-08ca-11eb-9dac-6f55ef0a3a7d", "1.0", "4b19bf6a-08cc-11eb-ad40-63f9910aca7b"));
		this.install(CoreConstructors.form("Oncology  Discontinuation form", "Discontinuation  form for oncology",
		    "7ae70e0c-08ca-11eb-9325-676401a68809", "1.0", "67b0c4de-08cc-11eb-ae4d-c756d1210d5c"));
		this.install(CoreConstructors.form("Oncology Followup form", "Followup form for oncology",
		    "984405fe-08ca-11eb-bb7a-cb6ccfe9c91e", "1.0", "884df5d6-08cc-11eb-a31e-27b10c64a0a7"));
		this.install(CoreConstructors.form("Cancer Screening and early diagnosis",
		    "Cancer Screening and early diagnosis form", "e24209cc-0a1d-11eb-8f2a-bb245320c623", "1.0",
